...
export interface ServerConfig { endpoint: string; transport: Transport; clientId?: string; scopes?: string[]; auth?: { flow?: AuthFlow; issuer?: string; authorizationEndpoint?: string; tokenEndpoint?: string; registrationEndpoint?: string; deviceCodeEndpoint?: string; redirectUri?: string }; tokens?: { file?: string; allowPlaintextRefreshToken?: boolean }; headers?: Record<string,string>; }
